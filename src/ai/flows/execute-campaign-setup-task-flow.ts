...
- **Instrucción:** Basado en el contexto, genera una lista de 4-6 pasos clave para configurar esta campaña en "{{strategyPlatform}}". Para cada paso, proporciona un título ("step") y una descripción detallada ("details") de lo que se debe hacer.
