...
// --- Schemas and Types defined directly in the API route ---
...
export async function POST(req: NextRequest) {
  ...
  try {
    ...
    // 4. Initialize Genkit and define the prompt
    // This is kept inside the handler to ensure it's re-initialized on each serverless invocation if needed,
    // avoiding stale configurations or state issues.
    ...
    const productDescriptionPrompt = ai.definePrompt({
      name: 'productDescriptionPrompt_api_v6', // Unique name
